...
$dataY = query("SELECT produksi FROM kacang_hijau ORDER BY tahun");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">persamaan prediksi produksi tanaman kacang hijau</h1>
