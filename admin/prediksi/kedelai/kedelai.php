...
$dataY = query("SELECT produksi FROM kedelai ORDER BY tahun");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">persamaan prediksi produksi tanaman kedelai</h1>
        ...
        <table class="table table-bordered">
            <thead class="thead-dark">
                <tr>
                    <th scope="col">No</th>
                    <th scope="col">Tahun</th>
                    <th scope="col">produksi (X)</th>
                    <th scope="col">produksi tahun setelahnya (Y)</th>
                    <th scope="col">XY</th>
                    <th scope="col">X2</th>
                </tr>
            </thead>
