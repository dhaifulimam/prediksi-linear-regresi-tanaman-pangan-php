...
$dataY = query("SELECT produksi FROM kacang_tanah ORDER BY tahun");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">persamaan prediksi produksi tanaman kacang tanah</h1>
