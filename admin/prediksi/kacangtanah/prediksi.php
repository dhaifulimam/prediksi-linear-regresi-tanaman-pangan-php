...
$data = query("SELECT * FROM kacang_tanah ORDER BY tahun");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">data produksi tanaman kacang tanah</h1>

        <div class="btnbtn">

            <a class="nav-item btn btn-primary add" href="" onclick="window.print()">cetak data</a>

            <a class="nav-item btn btn-warning add kembali" href="kacangtanah.php">kembali</a>
        ...
        <div class="hasilpre">
            ...
            <?php @$tahun = query("SELECT * FROM kacang_tanah ORDER BY tahun DESC limit 1");
            foreach ($tahun as $th) {
                $thn = $th["tahun"];
                // echo $thn;
            }
