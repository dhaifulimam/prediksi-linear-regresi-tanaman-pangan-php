...
$data = query("SELECT * FROM jagung ORDER BY tahun");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">data produksi tanaman jagung</h1>

        <div class="btnbtn">

            <a class="nav-item btn btn-primary add" href="" onclick="window.print()">cetak data</a>

            <a class="nav-item btn btn-warning add kembali" href="jagung.php">kembali</a>
        ...
        <div class="hasilpre">
            ...
            <?php @$tahun = query("SELECT tahun FROM jagung ORDER BY tahun DESC limit 1");
            foreach ($tahun as $th) {
                $thn = $th["tahun"];
                // echo $thn;
            }
