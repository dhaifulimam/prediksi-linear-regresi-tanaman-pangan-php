...
$dataY = query("SELECT produksi FROM jagung ORDER BY tahun");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">persamaan prediksi produksi tanaman jagung</h1>
