            ...
            <div class="col-12 info-panel">
                <div class="row">
                    <div class="col-lg d-flex justify-content-center">
                        <h2>Prediksi produksi tanaman pangan</h2>
                    </div>
                </div>

                <div class="row">
                    <div class="col-lg">
                        <a href="padi/padidt.php">
                            <img src="../icon/padi.png" alt="">
                            <h4>padi</h4>
                        </a>
                    </div>
                    <div class="col-lg">
                        <a href="jagung/jagungdt.php">
                            <img src="../icon/jagung.png" alt="">
                            <h4>jagung</h4>
                        </a>
                    </div>
                    <div class="col-lg">
                        <a href="kedelai/kedelaidt.php">
                            <img src="../icon/kedelai.png" alt="">
                            <h4>kedelai</h4>
                        </a>
                    </div>
                    <div class="col-lg">
                        <a href="kacangtanah/kacangtanahdt.php">
                            <img src="../icon/kacangtanah.png" alt="">
                            <h4>kacang tanah</h4>
                        </a>
                    </div>
                    <div class="col-lg">
                        <a href="kacanghijau/kacanghijaudt.php">
                            <img src="../icon/kacanghijau.png" alt="">
                            <h4>kacang hijau</h4>
                        </a>
                    </div>
                    <div class="col-lg">
                        <a href="ubikayu/ubikayudt.php">
                            <img src="../icon/ubikayu.png" alt="">
                            <h4>ubi kayu</h4>
                        </a>
                    </div>
                    <div class="col-lg">
                        <a href="ubijalar/ubijalardt.php">
