...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">data produksi tanaman ubi kayu</h1>
            ...
            <tbody>
                <?php foreach ($data as $dt) : ?>
                    <tr>
                        ...
                        <td><a class="btn btn-warning admin" href="ubah.php?id=<?= $dt["id_ubikayu"]; ?>">ubah</a>
                            <a class="btn btn-danger admin" href="hapus.php?id=<?= $dt["id_ubikayu"]; ?>">hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
