...
$update = query("SELECT * FROM ubikayu WHERE id_ubikayu = $id")[0];

if (isset($_POST["submit"])) {

    if (ubahubikayu($_POST) > 0) {
        echo "
                <script>
...
<body>
    ...
    <div class="container content">
        ...
        <form action="" method="POST">
            <input type="hidden" name="id" value="<?= $update["id_ubikayu"]; ?>">
            ...
            <div class="form-group">
                <label for="produksi">produksi tanaman ubi kayu</label>
