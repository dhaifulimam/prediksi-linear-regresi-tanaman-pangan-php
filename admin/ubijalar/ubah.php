...
$update = query("SELECT * FROM ubijalar WHERE id_ubijalar = $id")[0];

if (isset($_POST["submit"])) {

    if (ubahubijalar($_POST) > 0) {
        echo "
                <script>
...
<body>
    ...
    <div class="container content">
        ...
        <form action="" method="POST">
            <input type="hidden" name="id" value="<?= $update["id_ubijalar"]; ?>">
            ...
            <div class="form-group">
                <label for="produksi">produksi tanaman ubi jalar</label>
