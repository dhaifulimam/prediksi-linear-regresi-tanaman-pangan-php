...
$data = query("SELECT * FROM padi ORDER BY tahun");
...
<body>
    ...
    <div class="container">
        ...
        <h1 class="header">data produksi tanaman padi</h1>
            ...
            <tbody>
                <?php foreach ($data as $dt) : ?>
                    <tr>
                        ...
                        <td><a class="btn btn-warning admin" href="ubah.php?id=<?= $dt["id_padi"]; ?>">ubah</a>
                            <a class="btn btn-danger admin" href="hapus.php?id=<?= $dt["id_padi"]; ?>">hapus</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
