...
$update = query("SELECT * FROM kedelai WHERE id_kedelai = $id")[0];

if (isset($_POST["submit"])) {

    if (ubahkedelai($_POST) > 0) {
        echo "
                <script>
...
<body>
    ...
    <div class="container content">
        ...
        <form action="" method="POST">
            <input type="hidden" name="id" value="<?= $update["id_kedelai"]; ?>">
            ...
            <div class="form-group">
                <label for="produksi">produksi tanaman kedalai</label>
