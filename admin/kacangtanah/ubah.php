...
$update = query("SELECT * FROM kacang_tanah WHERE id_kacangT = $id")[0];

if (isset($_POST["submit"])) {

    if (ubahkacangtanah($_POST) > 0) {
        echo "
                <script>
...
<body>
    ...
    <div class="container content">
        ...
        <form action="" method="POST">
            <input type="hidden" name="id" value="<?= $update["id_kacangT"]; ?>">
            ...
            <div class="form-group">
                <label for="produksi">produksi tanaman kacang tanah</label>
